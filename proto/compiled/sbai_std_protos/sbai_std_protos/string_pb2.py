...
# source: sbai_std_protos/sbai_std_protos/string.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='sbai_std_protos/sbai_std_protos/string.proto',
  package='sbai_std_protos',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n,sbai_std_protos/sbai_std_protos/string.proto\x12\x0fsbai_std_protos\"\x16\n\x06String\x12\x0c\n\x04\x64\x61ta\x18\x01 \x01(\tb\x06proto3'
)
...
String = _reflection.GeneratedProtocolMessageType('String', (_message.Message,), {
  'DESCRIPTOR' : _STRING,
  '__module__' : 'sbai_std_protos.sbai_std_protos.string_pb2'
